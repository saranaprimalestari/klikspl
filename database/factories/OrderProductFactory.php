...
class OrderProductFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'product_category' => $this->faker->sentence(mt_rand(1,5)),
            'product_merk' => $this->faker->sentence(mt_rand(1,5)),
            'variant_name' => $this->faker->sentence(mt_rand(1,5)),
            'variant_value' => $this->faker->sentence(mt_rand(1,5)),
            'variant_code' => $this->faker->sentence(mt_rand(1,5)),
            'stock' => mt_rand(1,10),
            'weight' =>  mt_rand(1000,5000),
            'price' =>  mt_rand(20000,2000000),
            'promo_name' => $this->faker->sentence(mt_rand(1,5)),
            'promo_discount' =>  mt_rand(20000,2000000),
        ];
    }
}
