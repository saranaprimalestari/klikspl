...
@section('container')
    ...
    <input id="on-chat-page" type="hidden" name="on_chat_page" value="1">
    <script>
        $(document).ready(function() {
                                ...
                                $.each(chats['chat_message'], function(idChat, chat) {
                                    if (chat['admin_id'] == null) {
                                        ...
                                        $('.inner-admin-chat-modal').append(
                                            ...
                                            // '<div class="m-0 mb-1 fw-600">' + chats[
                                            //     'admin']['username'] +
                                            // '</div>' +
                                            '<p class="m-0 mb-2">' + chat[
                                                'chat_message'] +
            ...
            function adminChatTextareaFocus() {
                setTimeout(() => {
                    $('#chat_admin_chat').focus();
                }, 500);
            }
