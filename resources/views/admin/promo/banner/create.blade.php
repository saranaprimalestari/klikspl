...
@section('container')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-md-3 pt-5 pb-3 mb-1">
        <h4 class="m-0">Tambah Promo Banner</h4>
    </div>
                        ...
                        <div class="col-md-9 col-6">
                            <div class="row mb-3">
                                <div class="col-md-12 col-12">
                                    ...
                                    <input required class="form-control form-control-sm promo-banner-image-class mb-3"
                                        id="promoBannerImage_0" type="file" name="promoBannerImage">
                                    <input required type="hidden" id="promoBannerImageUpload_0"
                                        class="promoBannerImageUpload_0" name="promoBannerImageUpload">
                                    {{-- <input required class="form-control form-control-sm promo-banner-image-class" id="promoBannerImageTemp_0"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input required type="datetime-local" class="form-control fs-14 @error('start_period') is-invalid @enderror"
                                ...
                                value="{{ old('start_period') }}" min="{{ \Carbon\Carbon::now()->isoFormat('Y-MM-DDTHH:mm') }}">
                            @error('start_period')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input required type="datetime-local" class="form-control fs-14 @error('end_period') is-invalid @enderror"
                                ...
                                value="{{ old('end_period') }}" min="{{ \Carbon\Carbon::now()->isoFormat('Y-MM-DDTHH:mm') }}">
                            @error('end_period')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
        ...
        $(document).ready(function() {
            ...
            $("body").on("change", ".promo-banner-image-class", function(e) {
                ...
                if (!allowedExtensions.exec(filePath)) {
                    ...
                    $('input[name="promoBannerImage[' + imageId + ']"]').val('');
                    return false;
                }
            ...
            $("#upload-promo-banner-image").click(function() {
                ...
                canvas.toBlob(function(blob) {
                    ...
                    reader.onloadend = function() {
                        ...
                        $('.show-before-upload-' + imageId).html(
                            ' <button type="button" class="fs-14 btn btn-danger preview-promo-banner-image-button mt-3" data-bs-toggle="modal" id="preview-modal-promo-banner-image-' +
                            imageId +
                            '" data-bs-target="#upload-promoBanner-img-modal">Lihat Foto </button>'
                        );
                        $('.promoBannerImageUpload_' + imageId).val(base64data);
                        $modal.modal('toggle');
                        // $.ajax({
                        //     type: "POST",
                        //     dataType: "json",
