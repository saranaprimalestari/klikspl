                    ...
                    <div
                        ...
                        <div class="card-body p-0 p-4">
                            <div class="row">
                                <div class="col-md-10 profile-address">
                                    ...
                                    <div class=" mt-2 d-flex align-items-center">
                                        @if ($address->is_active != 1)
                                            {{-- <button type="submit"
                                                    class="btn btn-danger profile-address-change-btn py-2 px-3 me-2">
                                                    <p>
                                                        Pilih Alamat
                                                    </p>
                                                </button> --}}
                                        ...
                                        @endif
                                        <a class="text-decoration-none text-danger profile-address-change-link"
                                            href="{{ route('useraddress.edit', $address) }}" role="button">
                                            Edit Alamat
                                        </a>
                                        @if ($address->is_active != 1)
                                            <span class="text-secondary mx-1"> | </span>
                                            <form action="{{ route('useraddress.destroy', $address) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <button type="submit"
                                ...
                                @if ($address->is_active == 1)
                                    <div
                                        class="col-md-2 d-flex align-items-center justify-content-center text-danger profile-address-active">
