...
class ForgotPasswordController extends Controller
{
    ...
    public function forgotPasswordGetCode(Request $request, MailController $mailController)
    {
        if (!is_null($request->session()->get('email')) || !is_null($request->session()->get('telp_no')) || !is_null($request->session()->get('verificationCode')) || !is_null($request->session()->get('is_verified')) || !is_null($request->session()->get('data')) || !is_null($request->session()->get('user_id'))) {
    ...
    public function forgotPasswordVerificationPost(Request $request)
    {
        if (!is_null($request->session()->get('email')) || !is_null($request->session()->get('telp_no')) || !is_null($request->session()->get('verificationCode')) || !is_null($request->session()->get('is_verified')) || !is_null($request->session()->get('data')) || !is_null($request->session()->get('user_id'))) {
    ...
    public function forgotPasswordResetPost(Request $request)
    {
    ...
    public function forgotPasswordResetComplete(Request $request)
    {
